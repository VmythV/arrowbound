...
export const LEVEL_CONFIGS: readonly LevelConfig[] = [
  createLevel(1, "新手靶场", 100, 30, 850, 390, 90, 0.12, -40, 5, 32, 900, 600),
  createLevel(2, "林间靶场", 220, 70, 880, 350, 85, 0.11, -42, 5, 35, 900, 620),
  createLevel(3, "溪谷靶场", 380, 120, 920, 420, 82, 0.1, -42, 8, 38, 900, 650),
